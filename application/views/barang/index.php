          ...
          <?php if (!empty($barang)): ?>
            <?php foreach ($barang as $key => $item): ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('barang/ubah/' . $item['id_barang']) ?>"
                    class="btn-small waves-effect waves-light yellow darken-3 tooltipped" data-position="top"
                    data-tooltip="Edit"><i class="material-icons">edit</i></a>
                  <a href="<?= base_url('barang/hapus/' . $item['id_barang']) ?>"
                    class="btn-small waves-effect waves-light red tooltipped" data-position="top" data-tooltip="Hapus"
