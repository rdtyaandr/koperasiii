...
<head>
    ...
    <style>
        ...
        .welcome-card img {
            max-width: 150px; /* Update ukuran gambar SVG */
        }
...
<div class="container-fluid" style="padding: 20px;">
    <div class="row">
        <div class="col s12">
            <div class="card hoverable" style="border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); background: #ffffff;">
                    ...
                    <div class="row">
                        <div class="col s12">
                            <div class="card welcome-card blue lighten-4 hoverable">
                                <div class="card-content">
                                    <div class="card-text">
                                        <span class="card-title">Selamat datang, <?php echo $this->session->userdata('name'); ?>!</span>
                                        <p>Kami senang Anda kembali.</p>
                                        <a href="<?php echo base_url('pinjaman'); ?>" class="btn-large">Ajukan peminjaman?</a>
                                    </div>
