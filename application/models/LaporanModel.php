...
class LaporanModel extends GLOBAL_Model
{
    public function get_filtered_data($year, $month = null, $day = null, $end_day = null, $payment_method = null) {
        $this->db->select('b.nama_barang, b.harga_beli, dt.harga as harga_jual, dt.jenis_barang, SUM(dt.jumlah) as jumlah, SUM((dt.harga * dt.jumlah) - (b.harga_beli * dt.jumlah)) as total_pendapatan, t.cara_bayar');
        ...
        $this->db->group_by('b.nama_barang, b.harga_beli, dt.harga, dt.jenis_barang, t.cara_bayar');
        $query = $this->db->get();
